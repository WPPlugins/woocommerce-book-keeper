...
Tags: woocommerce, exporter, accounting, export, woo, book keeping, e-commerce, account code, woothemes, accountant, bookkeeping, plugin, csv export, csv
...
= You need more ? Expert version is available for you =

If you need more functionnalities, you should have a look to our [premium version](http://woocommerce-book-keeper.com/shop/woocommerce-book-keeper-expert/ "Woocommerce Book Keeper Website")
...
* Compatible with [Table Rate Shipping (Bolder Elements)](http://bolderelements.net/plugins/table-rate-shipping-woocommerce/ "Table Rate Shipping (Bolder Elements)")
...
* Correction of illegal tax on coupon codes used before Woocommerce 2.3.
* Choice of the date to use (order date / validation date).
...
Not yet, but we are working on it on the Expert version. It will be available on the 1.03 version of Expert plugin (next release).

= Is Woocommerce Book Keeper compatible with invoices plugin? =

The free version is not, but with the Expert version you can use Woocommerce PDF invoices and packing slips with WBK.
...
Well it's easy, if this plugin makes your work easier, allows you to have a friday afternoon with your friends/family/dog, or lets you save some bucks, give us [5 stars here](https://wordpress.org/support/view/plugin-reviews/woocommerce-book-keeper "Give us 5 Stars !") !
